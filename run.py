...
#
parser.add_argument('--cut1', type=int, default=96, help='interaction_back_window')
parser.add_argument('--cut2', type=int, default=24, help='interaction_forecst_window')
parser.add_argument('--hidden1', type=int, default=1440, help='MLP_backbone_hiiden1')
parser.add_argument('--hidden2', type=int, default=720, help='MLP_backbone_hiiden2')
...
parser.add_argument('--linear', type=int, default=1, help='1: linear; 0: MLP')
...
parser.add_argument('--centralization', type=int, default=0, help='whether normalize the patch')
...
parser.add_argument('--noisy_gating', type=int, default=1, help='0: subtract mean; 1: subtract last')
parser.add_argument('--num_experts', type=int, default=1, help='decomposition; True 1 False 0')
parser.add_argument('--k', type=int, default=1, help='decomposition-kernel')
parser.add_argument('--CI', type=int, default=1, help='0: subtract mean; 1: subtract last')
parser.add_argument('--hidden_size', type=int, default=256, help='0: subtract mean; 1: subtract last')
